...
| ❌ **MCP timeout = 任务失败**（2026-06-14 绘本 5 次跑）| 看到 `wait_and_download` 120s timeout → 重提交 = 重复扣费 | check_task 查 status → running 就再 wait·succeeded 读 output_path |
