...
| **v15 填模板脚本** | `scripts/fill_v15_template.py`（**v1.0.3+pic12 已修复 pic4 硬编码** · CLI 参数 `--project-dir/--version/--tone` · 兼容 v15 4 段 + v6 5 段 + en_color 字符串 + en_color_pattern 字典 · 0 行硬编码）|
| **Pic5 Bird 鸟 8 段 v6 模板首次跑通** | [references/2026-06-07-pic5-bird-validation.md](references/2026-06-07-pic5-bird-validation.md)（v1.0.3+pic13 · 8/8 succeeded · 整数时长 0 错位 · 50.66s · 8 task 并行轮询 ~7min · 4 维加权 3.8/5 首次实战 · en_color_pattern 清洗 · fill_v6_bird.py 复发待清理）|
| **Pic6 Cow 牛 v1 实战验证** | [references/2026-06-08-pic6-cow-validation.md](references/2026-06-08-pic6-cow-validation.md)（v1.0.3+pic13 · 8 Clip 58s · 4 维加权 4.40/5 · C 600s timeout 原料齐全 · clip1 端到端先验 succeeded 9 轮 135s · **fill_v15 兜底 bird/鸟 hardcode 翻车修复** · 铁律 #86 #87 沉淀）|
