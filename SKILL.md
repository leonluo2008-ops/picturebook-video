...
**触发词**: 加载动画绘本skill、动画绘本skill、绘本视频、绘本转视频、绘本动画、v8.1 写法、SRT 时间戳、动作模板、单仓安装、音频路由、generate_audio、无 BGM、有声视频。
**触发分界（2026-09-18 用户定版）**: 「加载绘本skill / 加载绘本制作skill / 绘本创作 / 画绘本」= picturebook-creator（静态绘本），本 skill 勿抢触发；本 skill 仅由「加载动画绘本skill / 动画绘本 / 绘本视频 / 绘本转视频 / 绘本动画」触发。
